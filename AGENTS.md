...
- `d100` means a percentile pair of two `d10` bodies (`00–90` plus `0–9`), while the result layer uses cryptographic randomness independently of visual physics.
- WebGL2 is the enhanced path. If the host disables WebGL2, keep fair numeric rolls, history, skins, and controls usable while clearly explaining that 3D is unavailable.
